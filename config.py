...
API_ID = 25993275
API_HASH = "1433951de25fde289b735ed4575946b9"
...
SUDO_USERS = list(map(lambda x: int(x), getenv("SUDO_USERS", default="5971645819").split()))
for x in ALTRON:
    SUDO_USERS.append(x)
OWNER_ID = int(getenv("OWNER_ID", default="5971645819"))
